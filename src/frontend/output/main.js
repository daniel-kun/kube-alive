...
var _user$project$AutoScaling$renderAutoScaling = F2(
	function (model, pod) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(pod.name),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(pod.status),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$AutoScaling$Model = F2(
	function (a, b) {
		return {isRunning: a, finishedRequests: b};
	});
var _user$project$AutoScaling$init = A2(_user$project$AutoScaling$Model, false, 0);
var _user$project$AutoScaling$ContinueLoadGenerator = function (a) {
	return {ctor: 'ContinueLoadGenerator', _0: a};
};
var _user$project$AutoScaling$makeLoadGeneratorRequest = function (makeMsg) {
	return A2(
		_elm_lang$http$Http$send,
		function (n) {
			return makeMsg(
				_user$project$AutoScaling$ContinueLoadGenerator(n));
		},
		_elm_lang$http$Http$getString('/cpuhog'));
};
var _user$project$AutoScaling$makeLoadGeneratorRequests = function (makeMsg) {
	return _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _user$project$AutoScaling$makeLoadGeneratorRequest(makeMsg),
			_1: {
				ctor: '::',
				_0: _user$project$AutoScaling$makeLoadGeneratorRequest(makeMsg),
				_1: {ctor: '[]'}
...
var _user$project$AutoScaling$update = F3(
	function (makeMsg, msg, model) {
		var autoScaling = model.autoScaling;
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'StartLoadGenerator':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							autoScaling: _elm_lang$core$Native_Utils.update(
								autoScaling,
								{isRunning: true})
						}),
					_1: _user$project$AutoScaling$makeLoadGeneratorRequests(makeMsg)
				};
			case 'StopLoadGenerator':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							autoScaling: _elm_lang$core$Native_Utils.update(
								autoScaling,
								{isRunning: false, finishedRequests: 0})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return autoScaling.isRunning ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							autoScaling: _elm_lang$core$Native_Utils.update(
								autoScaling,
								{finishedRequests: autoScaling.finishedRequests + 1})
						}),
					_1: _user$project$AutoScaling$makeLoadGeneratorRequests(makeMsg)
				} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$AutoScaling$StopLoadGenerator = {ctor: 'StopLoadGenerator'};
var _user$project$AutoScaling$StartLoadGenerator = {ctor: 'StartLoadGenerator'};
var _user$project$AutoScaling$view = F3(
	function (makeMsg, podList, model) {
		return {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Experiment 3: Auto-Scaling'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: model.isRunning ? A2(
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Events$onClick(
									makeMsg(_user$project$AutoScaling$StopLoadGenerator)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Stop load generator'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_nathanfox$elm_string_format$String_Format$format1, '{1} requests finished', model.finishedRequests)),
							_1: {ctor: '[]'}
						}
					}) : A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							makeMsg(_user$project$AutoScaling$StartLoadGenerator)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Start load generator'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$AutoScaling$renderAutoScaling(model),
							A2(
								_elm_lang$core$List$filter,
								function (n) {
									return _elm_lang$core$Native_Utils.eq(n.app, 'cpuhog');
								},
								podList))),
					_1: {ctor: '[]'}
				}
...
var _user$project$KubernetesApiModel$KubernetesResultMetadata = function (a) {
	return {resourceVersion: a};
};
var _user$project$KubernetesApiModel$KubernetesPodUpdate = F2(
	function (a, b) {
		return {updateType: a, object: b};
	});
var _user$project$KubernetesApiModel$KubernetesPodResult = F2(
	function (a, b) {
		return {metadata: a, items: b};
	});
var _user$project$KubernetesApiModel$KubernetesPodItem = F2(
	function (a, b) {
		return {metadata: a, status: b};
	});
var _user$project$KubernetesApiModel$KubernetesPodMetadata = F4(
	function (a, b, c, d) {
		return {name: a, uid: b, labels: c, deletionTimestamp: d};
	});
var _user$project$KubernetesApiModel$KubernetesLabels = function (a) {
	return {app: a};
};
var _user$project$KubernetesApiModel$KubernetesPodStatus = F4(
	function (a, b, c, d) {
		return {phase: a, conditions: b, hostIP: c, podIP: d};
	});
var _user$project$KubernetesApiModel$KubernetesPodCondition = F2(
	function (a, b) {
		return {conditionType: a, status: b};
	});

var _user$project$KubernetesApiDecoder$decodeKubernetesResultMetadata = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$KubernetesApiModel$KubernetesResultMetadata,
	A2(_elm_lang$core$Json_Decode$field, 'resourceVersion', _elm_lang$core$Json_Decode$string));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodStatusCondition = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$KubernetesApiModel$KubernetesPodCondition,
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'status', _elm_lang$core$Json_Decode$string));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodStatus = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$KubernetesApiModel$KubernetesPodStatus,
	A2(_elm_lang$core$Json_Decode$field, 'phase', _elm_lang$core$Json_Decode$string),
	_elm_lang$core$Json_Decode$maybe(
		A2(
			_elm_lang$core$Json_Decode$field,
			'conditions',
			_elm_lang$core$Json_Decode$list(_user$project$KubernetesApiDecoder$decodeKubernetesPodStatusCondition))),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'hostIP', _elm_lang$core$Json_Decode$string)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'podIP', _elm_lang$core$Json_Decode$string)));
var _user$project$KubernetesApiDecoder$decodeKubernetesLabels = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$KubernetesApiModel$KubernetesLabels,
	A2(_elm_lang$core$Json_Decode$field, 'app', _elm_lang$core$Json_Decode$string));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodMetadata = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$KubernetesApiModel$KubernetesPodMetadata,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'uid', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'labels', _user$project$KubernetesApiDecoder$decodeKubernetesLabels),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'deletionTimestamp', _elm_lang$core$Json_Decode$string)));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodItem = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$KubernetesApiModel$KubernetesPodItem,
	A2(_elm_lang$core$Json_Decode$field, 'metadata', _user$project$KubernetesApiDecoder$decodeKubernetesPodMetadata),
	A2(_elm_lang$core$Json_Decode$field, 'status', _user$project$KubernetesApiDecoder$decodeKubernetesPodStatus));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodResult = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$KubernetesApiModel$KubernetesPodResult,
	A2(_elm_lang$core$Json_Decode$field, 'metadata', _user$project$KubernetesApiDecoder$decodeKubernetesResultMetadata),
	A2(
		_elm_lang$core$Json_Decode$field,
		'items',
		_elm_lang$core$Json_Decode$list(_user$project$KubernetesApiDecoder$decodeKubernetesPodItem)));
var _user$project$KubernetesApiDecoder$decodeKubernetesPodUpdate = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$KubernetesApiModel$KubernetesPodUpdate,
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'object', _user$project$KubernetesApiDecoder$decodeKubernetesPodItem));

var _user$project$LoadBalancing$renderLoadBalancing = F2(
	function (loadBalancing, pod) {
		return A2(
			_elm_lang$html$Html$tr,
			{ctor: '[]'},
			{
								...
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(
										A2(
											...
											function (n) {
												return _elm_lang$core$Native_Utils.eq(n, pod.podIP);
											},
											loadBalancing.responses))),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' responses'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$LoadBalancing$Model = function (a) {
	return {responses: a};
};
var _user$project$LoadBalancing$init = _user$project$LoadBalancing$Model(
	{ctor: '[]'});
var _user$project$LoadBalancing$ReceiveLoadBalanceResponse = function (a) {
	return {ctor: 'ReceiveLoadBalanceResponse', _0: a};
};
var _user$project$LoadBalancing$update = F3(
	function (makeMsg, msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ExecLoadBalanceTest') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _elm_lang$core$Platform_Cmd$batch(
					A2(
						...
						A2(
							...
							function (m) {
								return makeMsg(
									_user$project$LoadBalancing$ReceiveLoadBalanceResponse(m));
							},
							_elm_lang$http$Http$getString('/getip'))))
			};
		} else {
			if (_p0._0.ctor === 'Ok') {
				var loadBalancing = model.loadBalancing;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							loadBalancing: _elm_lang$core$Native_Utils.update(
								loadBalancing,
								{
									responses: {ctor: '::', _0: _p0._0._0, _1: loadBalancing.responses}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$LoadBalancing$ExecLoadBalanceTest = {ctor: 'ExecLoadBalanceTest'};
var _user$project$LoadBalancing$view = F3(
	function (makeMsg, podList, loadBalancing) {
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$h1,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Experiment 1: Load-Balancing'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							makeMsg(_user$project$LoadBalancing$ExecLoadBalanceTest)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Make 50 requests to getip'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$LoadBalancing$renderLoadBalancing(loadBalancing),
							A2(
								_elm_lang$core$List$filter,
								function (n) {
									return _elm_lang$core$Native_Utils.eq(n.app, 'getip');
								},
								podList))),
					_1: {ctor: '[]'}
				}
...
var _user$project$SelfHealing$renderPod = function (pod) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		{
...
var _user$project$SelfHealing$Model = F2(
	function (a, b) {
		return {x: a, healthy: b};
	});
var _user$project$SelfHealing$init = A2(_user$project$SelfHealing$Model, 0, true);
var _user$project$SelfHealing$StatusPollResponse = function (a) {
	return {ctor: 'StatusPollResponse', _0: a};
};
var _user$project$SelfHealing$StatusPollTimer = function (a) {
	return {ctor: 'StatusPollTimer', _0: a};
};
var _user$project$SelfHealing$subscriptions = F2(
	function (makeMsg, model) {
		return A2(
			_elm_lang$core$Time$every,
			500 * _elm_lang$core$Time$millisecond,
			function (t) {
				return makeMsg(
					_user$project$SelfHealing$StatusPollTimer(t));
			});
	});
var _user$project$SelfHealing$KillService = {ctor: 'KillService'};
var _user$project$SelfHealing$ServiceInfectOrKillResponse = function (a) {
	return {ctor: 'ServiceInfectOrKillResponse', _0: a};
};
var _user$project$SelfHealing$update = F3(
	function (makeMsg, msg, model) {
		var selfHealing = model.selfHealing;
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'InfectService':
				return {
					...
					_1: A2(
						...
						function (m) {
							return makeMsg(
								_user$project$SelfHealing$ServiceInfectOrKillResponse(m));
						},
						A3(_elm_lang$http$Http$post, '/healthcheck/infect', _elm_lang$http$Http$emptyBody, _elm_lang$core$Json_Decode$string))
				};
			case 'KillService':
				return {
					ctor: '_Tuple2',
					...
					_1: A2(
						...
						A3(_elm_lang$http$Http$post, '/healthcheck/kill', _elm_lang$http$Http$emptyBody, _elm_lang$core$Json_Decode$string))
				};
			case 'ServiceInfectOrKillResponse':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'StatusPollTimer':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selfHealing: _elm_lang$core$Native_Utils.update(
								selfHealing,
								{x: selfHealing.x + 1})
						}),
					_1: A2(
						...
						function (m) {
							return makeMsg(
								_user$project$SelfHealing$StatusPollResponse(m));
						},
						_elm_lang$http$Http$getString('/healthcheck/'))
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
...
var _user$project$SelfHealing$InfectService = {ctor: 'InfectService'};
var _user$project$SelfHealing$view = F3(
	function (makeMsg, pods, model) {
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Experiment 2: Self-Healing'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									makeMsg(_user$project$SelfHealing$InfectService)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Infect service'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										makeMsg(_user$project$SelfHealing$KillService)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Kill service'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: model.healthy ? A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Service healthy'),
										_1: {ctor: '[]'}
									}) : A2(
									_elm_lang$html$Html$span,
									{
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Service unhealthy'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										A2(
											_elm_lang$core$List$map,
											_user$project$SelfHealing$renderPod,
											A2(
												_elm_lang$core$List$filter,
												function (n) {
													return _elm_lang$core$Native_Utils.eq(n.app, 'healthcheck');
												},
												pods))),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$selectAllPodsExcept = F2(
	function (podUpdate, podInfo) {
		return !_elm_lang$core$Native_Utils.eq(podUpdate.object.metadata.uid, podInfo.uid);
	});
var _user$project$Main$makePodIP = function (item) {
	var _p0 = item.status.podIP;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return '';
...
var _user$project$Main$makePodInfoStatus = function (item) {
	var _p1 = item.metadata.deletionTimestamp;
	if (_p1.ctor === 'Just') {
		return 'Terminating';
	} else {
...
var _user$project$Main$updatePodInfo = F2(
	function (podUpdate, podInfo) {
		return _elm_lang$core$Native_Utils.eq(podUpdate.object.metadata.uid, podInfo.uid) ? _elm_lang$core$Native_Utils.update(
			podInfo,
			{
				status: _user$project$Main$makePodInfoStatus(podUpdate.object)
			}) : podInfo;
	});
var _user$project$Main$PodInfo = F5(
	function (a, b, c, d, e) {
		return {name: a, uid: b, app: c, status: d, podIP: e};
	});
var _user$project$Main$makePodInfo = function (item) {
	return A5(
		_user$project$Main$PodInfo,
		item.metadata.name,
		item.metadata.uid,
		item.metadata.labels.app,
		_user$project$Main$makePodInfoStatus(item),
		_user$project$Main$makePodIP(item));
};
var _user$project$Main$makePodList = function (newPodList) {
	return A2(_elm_lang$core$List$map, _user$project$Main$makePodInfo, newPodList.items);
};
var _user$project$Main$addOrUpdatePod = F2(
	function (podList, podUpdate) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(
				A2(
					_elm_lang$core$List$filter,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.uid, podUpdate.object.metadata.uid);
					},
					podList)),
			0) > 0) ? A2(
			_elm_lang$core$List$map,
			_user$project$Main$updatePodInfo(podUpdate),
			podList) : {
			ctor: '::',
			_0: _user$project$Main$makePodInfo(podUpdate.object),
			_1: podList
		};
	});
var _user$project$Main$updatePodList = F2(
	function (podList, podUpdate) {
		var _p2 = podUpdate.updateType;
		switch (_p2) {
			case 'MODIFIED':
				return A2(_user$project$Main$addOrUpdatePod, podList, podUpdate);
			case 'DELETED':
				return A2(
					_elm_lang$core$List$filter,
					_user$project$Main$selectAllPodsExcept(podUpdate),
					podList);
			case 'ADDED':
				return A2(_user$project$Main$addOrUpdatePod, podList, podUpdate);
			default:
...
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {podList: a, originHost: b, podListResourceVersion: c, debugText: d, loadBalancing: e, selfHealing: f, autoScaling: g};
	});
var _user$project$Main$Flags = function (a) {
	return {originHost: a};
};
var _user$project$Main$AutoScalingMsg = function (a) {
	return {ctor: 'AutoScalingMsg', _0: a};
};
var _user$project$Main$SelfHealingMsg = function (a) {
	return {ctor: 'SelfHealingMsg', _0: a};
};
var _user$project$Main$LoadBalancingMsg = function (a) {
	return {ctor: 'LoadBalancingMsg', _0: a};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
				...
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								debugText: 'Loaded.',
								podList: _user$project$Main$makePodList(_p4),
								podListResourceVersion: _p4.metadata.resourceVersion
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{debugText: 'Fetch error'}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'PodUpdate':
				var parseResult = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$KubernetesApiDecoder$decodeKubernetesPodUpdate, _p3._0);
				var _p5 = parseResult;
				if (_p5.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								podList: A2(_user$project$Main$updatePodList, model.podList, _p5._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'LoadBalancingMsg':
				return A3(_user$project$LoadBalancing$update, _user$project$Main$LoadBalancingMsg, _p3._0, model);
			case 'SelfHealingMsg':
				return A3(_user$project$SelfHealing$update, _user$project$Main$SelfHealingMsg, _p3._0, model);
			default:
				return A3(_user$project$AutoScaling$update, _user$project$Main$AutoScalingMsg, _p3._0, model);
		}
	});
var _user$project$Main$view = function (model) {
	var podList = A2(
		_elm_lang$core$List$map,
		function (n) {
			return {name: n.name, status: n.status, app: n.app, podIP: n.podIP};
		},
		model.podList);
	return A2(
		_elm_lang$html$Html$div,
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(model.debugText),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(model.originHost),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						},
						{
							...
							_0: A2(
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: '#962E2E'},
												_1: {
													ctor: '::',
								...
								A3(_user$project$LoadBalancing$view, _user$project$Main$LoadBalancingMsg, podList, model.loadBalancing)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: '#473f54'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'color', _1: 'white'},
														_1: {
									...
									A3(_user$project$SelfHealing$view, _user$project$Main$SelfHealingMsg, podList, model.selfHealing)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
											...
											_0: _elm_lang$html$Html_Attributes$style(
												{
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'backgroundColor', _1: '#294f82'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'color', _1: 'white'},
															_1: {
										...
										A3(_user$project$AutoScaling$view, _user$project$Main$AutoScalingMsg, podList, model.autoScaling)),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Main$PodUpdate = function (a) {
	return {ctor: 'PodUpdate', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: function () {
				var _p6 = model.podListResourceVersion;
				if (_p6 === '') {
					return _elm_lang$core$Platform_Sub$none;
				} else {
					return A2(
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$SelfHealing$subscriptions, _user$project$Main$SelfHealingMsg, model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$PodList = function (a) {
	return {ctor: 'PodList', _0: a};
};
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: A7(
			...
			'',
			'(Loading)',
			_user$project$LoadBalancing$init,
			_user$project$SelfHealing$init,
			_user$project$AutoScaling$init),
		_1: A2(
			_elm_lang$http$Http$send,
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'originHost', _elm_lang$core$Json_Decode$string)));
